...
class SOM(object):
    ...
    def display_widgets(self):
        ...
        left = widgets.VBox([self.iterations,
                            ...
                            self.initial_radius])
        right = widgets.VBox([self.button])
...
#         def generate_SOM(self,x_size,y_size,data,initial_radius,number_of_iterations,initial_learning_rate): 
...
#                 k_layer = self.Kohonen_Layer(x_size,y_size,data)
#                 data_length = np.arange(0,data.shape[0]-1,1)
#                 bmu_list = []
#                 cols_list = []
#                 rows_list = []
...
#         SOM.generate_SOM(som_maker,x_size=50,y_size=75,data=train_data,initial_radius=100,number_of_iterations=100,initial_learning_rate=0.1)
        
#         Where each variable has the following property:
#                 x_size: length of SOM x dimension 
#                 y_size: length of SOM y dimension 
#                 data: training data which you present to the algorithm with shape [N,F]
